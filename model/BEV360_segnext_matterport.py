...
class BEV360_segnext(nn.Module):
    ...
    def __init__(self, cfg, device):
        ...
        self.linear_c4 = LinearMLP(input_dim=self.embed_dims_lin[3],
                                   embed_dim=self.decoder_dim)
        self.linear_c3 = LinearMLP(input_dim=self.embed_dims_lin[2],
                                   embed_dim=self.decoder_dim)
        self.linear_c2 = LinearMLP(input_dim=self.embed_dims_lin[1],
                                   embed_dim=self.decoder_dim)
    ...
    def forward(self, rgb, proj_indices, rgb_no_norm, map_mask, map_heights):
