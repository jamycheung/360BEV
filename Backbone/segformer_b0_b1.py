...
class mit_b0(Segformer_b0_b1):
    def __init__(self, **kwargs):
        super(mit_b0, self).__init__( num_classes=21,
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1, decoder_dim=256)


class mit_b1(Segformer_b0_b1):
    def __init__(self, **kwargs):
        super(mit_b1, self).__init__(num_classes=21,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1, decoder_dim=256)

class mit_b2(Segformer_b0_b1):
    def __init__(self, **kwargs):
        super(mit_b2, self).__init__(num_classes=21,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
class mit_b4(Segformer_b0_b1):
    def __init__(self, **kwargs):
        super(mit_b4, self).__init__(num_classes=21,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
