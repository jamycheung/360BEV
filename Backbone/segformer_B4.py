...
class Segformer_B4(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=20, embed_dims=[64, 128, 320, 512],
                 ...
                 depths=[3, 8, 27, 3], sr_ratios=[8, 4, 2, 1], decoder_dim=768): #256
        super().__init__()
